 ...
 * Requires config.php beside this file (RESEND_API_KEY, CONTACT_TO, CONTACT_FROM).
 * If config.php is missing the handler still responds — it just reports that
 * email isn't configured yet. Copy config.example.php to config.php.
 */

if (is_file(__DIR__ . '/config.php')) {
    require_once __DIR__ . '/config.php';
} else {
    error_log('Tegrach: platform/php/config.php is missing — copy config.example.php and set your Resend key.');
}
